// src/screens/manager/ManagerApprovals.tsx
...
import { useManagerLeadsStore, LeadStatus } from "../../stores/leadStore";
import { useCompiledFileStore } from "../../stores/compiledFileStore";

// 🔁 Status flow – Manager ke liye sirf 5 statuses
