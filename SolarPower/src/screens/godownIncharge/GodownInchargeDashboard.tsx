// src/screens/godownIncharge/GodownInchargeDashboard.tsx
...
import { useGodownInchargeDashboardStore } from "../../stores/godownInchargeDashboardStore";

const GodownInchargeDashboard: React.FC = () => {
    ...
    const {
        ...
        fetchDashboard,
    } = useGodownInchargeDashboardStore();
        ...
        >
            ...
            <View className="mb-3">
                <Text className="text-xl font-bold text-emerald-900">
                    Godown Incharge Dashboard
                </Text>
                <Text className="text-[12px] text-slate-500 mt-1">
                    Inventory, leads & warehouse operations
                </Text>
            </View>
...
export default GodownInchargeDashboard;
