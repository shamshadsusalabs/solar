// src/screens/chief/ChiefDashboard.tsx
...
import { useChiefDashboardStore } from "../../stores/chiefDashboardStore";
        ...
        >
            ...
            <View className="mb-3">
                ...
                <Text className="text-[12px] text-slate-500 mt-1">
                    Operations, team management & performance
                </Text>
            </View>
