// src/screens/chief/ChiefBottomTabs.tsx
import React from "react";
import { View, Text, Pressable } from "react-native";
import { LayoutDashboard, UserCircle, ClipboardCheck } from "lucide-react-native";

type ChiefBottomTabsProps = {
...
const ChiefBottomTabs: React.FC<ChiefBottomTabsProps> = ({
    onDashboardPress,
    onApprovalsPress,
    onAccountPress,
}) => {
    return (
        <View className="flex-row justify-around pb-2 pt-3 px-4 bg-white border-t border-emerald-100 shadow-md">
            {/* Dashboard */}
...
export default ChiefBottomTabs;
