// src/screens/chief/ChiefApprovals.tsx
...
import { useChiefLeadsStore, LeadStatus } from "../../stores/leadStore";
import { useCompiledFileStore } from "../../stores/compiledFileStore";

// 🔁 Status flow – Chief ke liye 6 statuses
...
const ChiefApprovals: React.FC = () => {
    const insets = useSafeAreaInsets();
    const { tokens } = useChiefAuthStore();
            ...
            >
                ...
                <View className="mb-4 px-1">
                    ...
                    <Text className="text-slate-500 mt-1 text-sm">
                        Review and update all leads from your team
                    </Text>
                </View>
