// src/auth/GodownInchargeLoginForm.tsx
...
const GodownInchargeLoginForm: React.FC = () => {
    const [email, setEmail] = useState("");
    const [password, setPassword] = useState("");
    const [localError, setLocalError] = useState<string | null>(null);

    const { loginGodownIncharge, loading, error } = useGodownInchargeAuthStore();
    ...
    const onLogin = async () => {
        ...
        await loginGodownIncharge(email.trim(), password);
        // App.tsx role se redirect karega GodownInchargeRootScreen pe
    };
        ...
        <>
            ...
            <View className="mb-4">
                ...
                <View className="flex-row items-center rounded-2xl border border-emerald-100 bg-emerald-50/60 px-3">
                    <TextInput
                        ...
                        placeholder="godown@example.com"
            ...
            <View className="mt-4 items-center">
                <Text className="text-[11px] text-slate-400">
                    Secure access • Encrypted connection • Warehouse portal
                </Text>
            </View>
        </>
    );
...
export default GodownInchargeLoginForm;
