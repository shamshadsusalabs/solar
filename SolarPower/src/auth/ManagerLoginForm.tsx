...
const ManagerLoginForm: React.FC = () => {
    ...
    const { loginManager, loading, error } = useManagerAuthStore();
    ...
    const onLogin = async () => {
        ...
        // App.tsx role se redirect karega ManagerRootScreen pe
    };
        ...
        <>
            ...
            <View className="mt-4 items-center">
                <Text className="text-[11px] text-slate-400">
                    Secure access • Encrypted connection • Management portal
                </Text>
            </View>
        </>
    );
